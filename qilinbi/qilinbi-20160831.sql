...
CREATE TABLE `yang_currency_recovery` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='货币-强制回收明细';

-- ----------------------------
-- Records of yang_currency_recovery
-- ----------------------------
INSERT INTO `yang_currency_recovery` VALUES ('1', '31', '1472565866', '1', '0', '3.0000', '0.70', '0.05', '0.05', '0.05', null);
...
CREATE TABLE `yang_currency_split` (
  ...
  `finish_time` int(11) DEFAULT NULL COMMENT '完成时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='货币-强制拆分明细';

-- ----------------------------
-- Records of yang_currency_split
-- ----------------------------
INSERT INTO `yang_currency_split` VALUES ('2', '25', '1472562912', '1', '0', '1.0000', '2.00', '0.70', '0.05', '0.05', '0.05', null);
...
INSERT INTO `yang_currency_user` VALUES ('15', '59', '25', '1129.0000', '0.0000', '0', '');
...
INSERT INTO `yang_currency_user` VALUES ('82', '59', '31', '1500.0000', '0.0000', '0', '');
...
INSERT INTO `yang_currency_user` VALUES ('85', '67', '31', '1485.0000', '0.0000', '0', '');
...
-- ----------------------------
INSERT INTO `yang_member` VALUES ('59', '867633862@qq.com', 'e10adc3949ba59abbe56e057f20f883e', '我是推荐人', 'e10adc3949ba59abbe56e057f20f883e', '我我14141', '我我14141', '1', '', '15998326815', '127.0.0.1', '1457592457', '127.0.0.1', '1472613216', '0', '0', '946.5919', '-113.0000', '/Uploads/Member/Head/2016-03-28/56f80917209b4.jpg', '个人简介111', '2', '52', '职位/头衔', '0', '1', '1972.0000', '');
...
INSERT INTO `yang_member` VALUES ('67', '275043418@qq.com', 'e10adc3949ba59abbe56e057f20f883e', '', 'e10adc3949ba59abbe56e057f20f883e', '', '', '1', '', '', '127.0.0.1', '1460600386', '127.0.0.1', '1472525647', '0', '0', '4750.0000', '0.0000', '', '', '0', '0', '', '0', '0', '0.0000', '');
...
INSERT INTO `yang_orders` VALUES ('760', '72', '25', '0', '0.1000', '121.0000', '71.0000', '0.0010', 'buy', '1461725438', '1472522698', '1');
...
INSERT INTO `yang_orders` VALUES ('772', '59', '25', '0', '0.1000', '100.0000', '0.0000', '0.0010', 'buy', '1472522738', '0', '0');
...
INSERT INTO `yang_orders` VALUES ('775', '59', '31', '0', '1.0000', '500.0000', '0.0000', '0.0100', 'sell', '1472526677', '0', '-1');
