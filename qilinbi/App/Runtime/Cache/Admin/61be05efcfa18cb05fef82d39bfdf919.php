...
$(".sidebar-list li").children("a").on("click",function(){
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">拆分管理</span></div>
        </div>
        ...
        <div class="result-wrap">
            ...
            <div class="result-title">
                <div class="result-list">
                    <a href="<?php echo U('Currency/addsplit');?>"><i class="icon-font"></i>新增拆分</a>
                </div>
            </div>
            <div class="result-content">
                <table class="result-tab" width="100%">
                    ...
                    <?php if(is_array($splitlist)): $i = 0; $__LIST__ = $splitlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php echo ($vo['currency_name']); ?></td>
                            <td><?php echo ($vo['price']); ?></td>
							<td><?php echo ($vo['mult']); ?></td>
                            <td><?php echo ($vo['member_get']); ?></td>
                            <td><?php echo ($vo['level1_get']); ?></td>
                            <td><?php echo ($vo['level2_get']); ?></td>
                            <td><?php echo ($vo['level3_get']); ?></td>
                            <td><?php echo (date('Y-m-d H:i:s',$vo['add_time'])); ?></td>
                            <td><?php if(empty($vo['finish_time'])): ?>###<?php else: echo (date("Y-m-d H:i:s",$vo["finish_time"])); endif; ?></td>
                            <td><?php if($vo['status'] == 0): ?>等待处理<?php endif; ?>
								<?php if($vo['status'] == 1): ?>处理中<?php endif; ?>
                                <?php if($vo['status'] == 2): ?>处理完成<?php endif; ?>
                                <?php if($vo['status'] == 3): ?>处理失败<?php endif; ?>
								</td>
