...
$(".sidebar-list li").children("a").on("click",function(){
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">回收管理</span></div>
        </div>
        ...
        <div class="result-wrap">
            ...
            <div class="result-title">
                <div class="result-list">
                    <a href="<?php echo U('Currency/addrecovery');?>"><i class="icon-font"></i>新增回收</a>
                </div>
            </div>
            <div class="result-content">
                <table class="result-tab" width="100%">
                    ...
                    <?php if(is_array($recoverylist)): $i = 0; $__LIST__ = $recoverylist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
