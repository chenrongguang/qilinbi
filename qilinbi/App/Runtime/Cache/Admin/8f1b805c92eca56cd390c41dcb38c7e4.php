...
<div class="main-wrap">
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">拆分新增</span></div>
    </div>
    <div class="result-wrap">
        <form action="<?php echo U('Currency/addsplitDo');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
            <div class="config-items">
                <div class="config-title">
                    <h1><i class="icon-font">&#xe00a;</i>拆分添加</h1>
                </div>
                <div class="result-content">
                    <table width="100%" class="insert-tab">
                        <tbody>
                        <tr>
                            <th width="15%"><i class="require-red">*</i>选择币种：</th>
                        ...
                        <tr>
                            <th><i class="require-red">*</i>拆分价格：</th>
                            <td><input id="price" name="price" type="text" value="1.0" readonly></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>拆分倍数：</th>
                            <td><input id="mult" name="mult" type="text" value="1.0" readonly></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>会员获得比例：</th>
                            <td><input id="member_get" name="member_get" type="text" value="0.7" readonly></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input id="level2_get" name="level2_get" type="text" value="0.05" readonly></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>3级返佣比例：</th>
                            <td><input id="level3_get" name="level3_get" type="text" value="0.05" readonly></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo U('Currency/split');?>"><input type="button" value="返回"  class="btn btn6"></a>
                            </td>
                        </tr>
                        </tbody></table>
                </div>
