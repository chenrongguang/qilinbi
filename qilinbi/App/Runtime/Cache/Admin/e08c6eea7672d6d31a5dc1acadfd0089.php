...
<div class="main-wrap">
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">回收新增</span></div>
    </div>
    <div class="result-wrap">
        <form action="<?php echo U('Currency/addrecoveryDo');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
            <div class="config-items">
                <div class="config-title">
                    <h1><i class="icon-font">&#xe00a;</i>回收添加</h1>
                </div>
                    ...
                    <table width="100%" class="insert-tab">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo U('Currency/recovery');?>"><input type="button" value="返回"  class="btn btn6"></a>
                            </td>
                        </tr>
                        </tbody></table>
                </div>
